...
The following microcontroller developer boards are supported for Amazon FreeRTOS. For additional supported boards, please visit the [AWS Device Catalog](https://devices.amazonaws.com/search?kw=freertos).
